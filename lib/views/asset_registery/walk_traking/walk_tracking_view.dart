...
import 'package:terrapipe/views/asset_registery/asset_registery_controller.dart';
...
class _WalkTrackingPageState extends State<WalkTrackingPage> {
  ...
  final AssetRegistryController assetRegistryController =
      Get.put(AssetRegistryController());
  double? area;
  ...
  void addPoint() {
    if (currentPosition != null) {
      setState(() {
        assetRegistryController.shapePoints.add(currentPosition!);
  ...
  /// Undo the last point
  void undoPoint() {
    if (assetRegistryController.shapePoints.isNotEmpty &&
        markers.isNotEmpty &&
        assetRegistryController.shapePoints.isNotEmpty) {
      setState(() {
        assetRegistryController.shapePoints.removeLast();
        markers.removeLast();
        assetRegistryController.shapePoints.removeLast();
      });
    }
  ...
  void savePolygon() {
    setState(() {
      if (assetRegistryController.shapePoints.length >= 3) {
        assetRegistryController.shapePoints.value = List.from(assetRegistryController.shapePoints);
        print("here is the polypoint ${assetRegistryController.shapePoints}");
        Get.bottomSheet(
                  ...
                  children: [
                    ...
                    CustomTextFormField(
                      ...
                      suffixIconWidget: Column(
                        ...
                        children: [
                          GestureDetector(
                            onTap: assetRegistryController.incrementValue,
                            child: const Icon(
                              Icons.arrow_drop_up,
                              size: 20,
                            ),
                          ...
                          GestureDetector(
                            onTap: assetRegistryController.decrementValue,
                            child: const Icon(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        CustomButton(
                          ...
                          onTap: () async {
                            Get.back();
                            await assetRegistryController.savePolygonTeraTrac();
                          },
                          textStyle: TextStyle(
                              color: AppColor.white,
  ...
  void startTracking() async {
    setState(() {
      ...
      assetRegistryController.shapePoints.clear();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ModalProgressHUD(
        inAsyncCall: assetRegistryController.isPolygonLoading.isTrue,
        color: Colors.white,
        opacity: 0.95,
            ...
            FlutterMap(
              ...
              children: [
                ...
                PolylineLayer(
                  polylines: [
                    Polyline(
                      points: assetRegistryController.shapePoints,
                      color: Colors.blue,
                      strokeWidth: 4.0,
                    ),
                  ],
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (isAddPointVisible)
                    ElevatedButton.icon(
                      onPressed: () {
                        assetRegistryController.finishShape(context);
                        assetRegistryController.shapePoints.length >= 3
                            ? Get.bottomSheet(
                          backgroundColor: AppColor.white,
                          isScrollControlled: true,
                          PolygonBottomSheet(),
